---
title: "STT 3850 Statistical Data Analysis 1<br>Course Syllabus for Spring 2018"
output: 
  html_document: 
    theme: cosmo
    highlight: textmate
...
* STATISTICAL DISTRIBUTIONS: Understand and explain the properties of shape, center, and spread in the context of observed variables and data; be able to calculate descriptive statistics for the variables in a dataset and calculate or simulate sampling distributions for commonly used statistics such as means and proportions.
...
* COMPARE AND CONNECT: Compare analytical/theoretical results with resampling/bootstrapping results to connect the different modes of exploration in probability and statistical analysis; also understand how datasets can be analyzed in many ways depending on the research question(s).

* STATISTICAL COMPUTING: Effectively and efficiently implement necessary statistical calculations and procedures in R.

* STATISTICS—THE BIG PICTURE: Understand why probability and statistics is important to you, to people in your field of study, to people in other disciplines, and the larger world around us.
...
* 40% of your course grade will come from DataCamp assignments
* 20% of your course grade will come from Exam 1
* 20% of your course grade will come from Exam 2
* 20% of your course grade will come from the comprehensive Final Exam
