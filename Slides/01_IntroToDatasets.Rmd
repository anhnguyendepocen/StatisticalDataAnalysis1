...
It also would be be helpful to read Chapter 1 of the textbook *Mathematical Statistics with Resampling and R* and Chapter 2 of the digital text [*Modern Dive*](https://moderndive.com/).
...
We will often discuss the **distribution** of a population/variable, which describes possible values and often they occur.


##

<p style="text-align:center;"><img src="images/analysispyramid.jpg" width = 700></p>
...
The `readr` package contains the function `read_csv()`, which many prefer. Create `draft_alt` using this function. How do `draft` and `draft_alt` differ? Let's explore and discuss!
...
Remember to use `library(dplyr)` or `library(tidyverse)`...
