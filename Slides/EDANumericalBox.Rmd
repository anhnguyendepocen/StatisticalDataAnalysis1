...
* [wells](https://raw.githubusercontent.com/STAT-JET-ASU/Datasets/master/Chihara/Bangladesh.csv): concentration of three contaminants for a sample of wells in Bangladesh 
...
Arsenic (ppm) can not be negative, but we can have a negative fence because the mathematics do not take shape into account.
...
## Comparing Groups, Tips by Smileyface
