...
The online _Cookbook for R_ shows some [color options](http://www.cookbook-r.com/Graphs/Colors_(ggplot2)/) and built-in color palettes for plots. You can use any web color by name (if it has one), hex code, or rgb value (e.g., [HTML Color Codes](https://htmlcolorcodes.com/color-names/)).

* color typically refers to points, lines, outlines
* fill typically refers to some internal shading
