...
The Mauna Loa Observatory on the island of Hawaii has been measuring the concentration of carbon dioxide (CO2) in earth’s atmosphere since the 1950's. It is part of the National Oceanic and Atmospheric Administration (NOAA). ([maunaloac02.csv](https://raw.githubusercontent.com/STAT-JET-ASU/Datasets/master/Instructor/maunaloaCO2.csv)) 

```{r, echo=FALSE}
CO2 <- read.csv("https://raw.githubusercontent.com/STAT-JET-ASU/Datasets/master/Instructor/maunaloaCO2.csv")
```
...
```{r}
ggplot(CO2, aes(x = decade, y = co2raw)) + geom_boxplot()
```
