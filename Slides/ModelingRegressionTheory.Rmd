...
The least squares line always passed through the point $(\bar{x}, \bar{y})$. We calculate the slope by finding the product of the deviations of the paired $(x, y)$ values from their respective means, then summing and scaling by the variance of the x variable.
