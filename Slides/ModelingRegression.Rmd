...
The function $f(\overrightarrow{x})$ can assume a variety of forms, depending on the system and relationships we are trying to model. Finding the right model is often an iterative process. We frequently assume that $\epsilon$ is a normally distributed random variable.
...
The intercept units are the same as the units of the $y$ variable.

MORE ON SLOPE HERE TBA
