...
<p style="text-align:center;"><img src="https://cdn-images-1.medium.com/max/1200/1*i7WFO9wP0wB-nv3YrkrMPg.png" width = 700></p>
...
There is also a function `read_csv()` in the `readr` package. How do the two functions differ?
