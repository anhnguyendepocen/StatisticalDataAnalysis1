...
The Excel spreadsheet `MouseDrugExample.xlsx` shows all possible regroupings, as does Table 3.1 in the textbook. We could find these in `R`, but it quickly becomes too many to be feasible. Instead, we randomly sample from the possible regroupings a very large number of times. This is a permutation resampling test.
