...
However, we do not care about the order of selection, just the total number of babies who have jaundice, so we need to combine the outcomes that have the same numbers of J's.
