...
plotZxbar <- ggplot(NULL, aes(-4:4)) +
  ...
  geom_area(stat = "function", 
            ...
            xlim = c(z_xbar, 4)) +
  scale_x_continuous(breaks = seq(-4,  4, 1)) +
  labs(title = paste("Standardized Distribution of Mean Protein in a Aample of", n, "Beef Patties"), 
