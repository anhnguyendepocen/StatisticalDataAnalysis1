...
pmf %>% 
  kable(digits = probdigits) %>% 
  row_spec(19, color = "white", background = "red", bold = TRUE) %>% 
  kable_styling(full_width = FALSE, 
                position = "left", 
                font_size = 14,
                bootstrap_options = c("striped"))
...
```{r}
pbinom(17, 20, 0.82, lower.tail = FALSE)
```

#### Visualize in a plot

We can calculate and plot the probabilities for all possible values of X. 
...
pmf %>% 
  kable(digits = 20) %>% 
  row_spec(19:21, color = "white", background = "red", bold = TRUE) %>% 
  kable_styling(full_width = FALSE, 
                position = "left", 
                font_size = 14,
                bootstrap_options = c("striped"))
