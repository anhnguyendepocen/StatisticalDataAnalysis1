...
* Effective Class Engagement (50%) --- Several different kinds of activities fall under this heading, including but not limited to hands-on labs, online discussions, surveys, and reflections. The [CBMS](https://www.cbmsweb.org/) statement “Active Learning in Post-Secondary Mathematics Education” emphasizes “classroom practices that engage students in activities, such as reading, writing, discussion, or problem solving, that promote higher-order thinking.” I will score engagement activities to reward a good faith effort on your part rather than for accuracy. Successful engagement will be indicated via a checkmark on the main page of AsULearn. Your overall engagement grade will be the percentage of checkmarks you earn. Instructor-scored activities such as DataCamp and discussion forums have dashed completion boxes and green checkmarks. You will mark your own completion for other activities like readings and videos, which have solid boxes and blue checkmarks. Deadlines for engagement activities will vary---see [AsULearn](https://asulearn.appstate.edu/) for additional details. To accommodate emergencies and provide some flexibility, I will drop the lowest 3 engagement assignments. No late engagement assignments will be accepted.

* Written Exams (40%) --- You will complete two exams in this course. Each exam will include two parts: (1) a take-home portion that assesses hands-on statistical data analysis and computing, including interpretation of results; and (2) an in-class portion that addresses conceptual and/or theoretical knowledge. These exams are primarily summative assessments. However, to encourage the idea of exams as a formative experiences, to accommodate emergencies, and to help you solidify your knowledge, you will be allowed to turn in revisions on one exam that will replace the original grade. Otherwise, no late exams or exam make-ups will be allowed.
...
Updated Sunday, January 12, 2020 @ 04:19 PM
