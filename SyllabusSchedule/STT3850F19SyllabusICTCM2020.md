...
You **must pass** the cumulative final exam to pass the course. No exceptions. Class attendance on project workdays will be factored into the project grades.

The Course Schedule and AsULearn contain additional information. This course will use the standard 10-point +/- grading scale (93--100 = A, 90--92 = A--, 87--89 = B+, etc.) to determine final grades. Grades will be kept on [AsULearn](https://asulearn.appstate.edu/). You should monitor your grades throughout the term to make sure they are complete and accurate. Feel free to inquire about your grades at any time.  

***
***
Note: The following information was added here from AsULearn for the purposes of expanding and including this syllabus on the [web site](http://cs.appstate.edu/~sjg/papers/ictcm20/) for the ICTCM2020 presentation "Using Technology as a Pathway Towards Equity, Diversity, and Inclusion" ([Sarah J. Greenwald](https://cs.appstate.edu/~sjg/) and [Jill E. Thomley](https://jillthomley.github.io/)).

**Example DataCamp Assignment Instructions in AsULearn**

PURPOSE: To learn the fundamentals of working with the R language and objects.

INSTRUCTIONS:

* Work through the exercises in the DataCamp course Introduction to R.
* Download your Statement of Accomplishment (completion) from DataCamp.
* Click Add Submission below and upload your Datacamp certificate to AsULearn.
* To receive full credit (2 points), you must earn at least 80% of the possible course XP.
* To receive partial credit (1 point), you must earn at least 60% of possible course XP.
* Fill out the Introduction to R Feedback Survey (1 point) to finish this assignment.

COLLABORATION: You may discuss this assignment and work with others.

The 10 assigned DataCamp courses were intended to introduce and build fundamental programming skills using `R` as well as statistical concepts. Students integrated and demonstrated these skills in individal and groups proects as well as on the final exam. All assigned courses were all available at the start of the semester and were due at intervals during the semester. The goal was to get students to engage in the material and be exposed to all the topics. The completion criterion required some degree of engagement with every exercise in the course, while the XP criterion ensured that students did not finish by simply taking all the hints and/or answers. The feedback surveys asked students to reflect on how long they spent completing the assignment and several other questions about value, appropriateness, and frustration.
