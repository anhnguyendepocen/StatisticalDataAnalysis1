...
The shape of the sampling distribution of $\hat{p}$ may look mildly right-skewed on the plots, but the skewness (which is less than 0.5) and the kurtosis (approximately 3) suggest that it can be considered approximately normal, despite the fact that binomials with $p$ near zero tend to be right-skewed.
