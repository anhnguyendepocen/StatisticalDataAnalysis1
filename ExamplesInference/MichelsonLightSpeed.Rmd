...
The distribution is unimodal and roughly symmetric. The left tail looks a *little* bit longer and heavier than the right tail, which is probably why the skewness calculation is very slightly negative and the kurtosis suggests slightly thicker tails.
