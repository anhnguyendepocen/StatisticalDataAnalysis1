---
title: "Estimation Example: Bangladesh Wells #1 (mean)"
...
The curved pattern of divergence from the straight line is typical of strongly right-skewed data.
...
The slight right skew in the sampling distribution means that the boundaries of the 95% percentile interval are slightly larger (to take the longer right tail into account) than the boundaries of the other two intervals, which assume a normal distribution.
