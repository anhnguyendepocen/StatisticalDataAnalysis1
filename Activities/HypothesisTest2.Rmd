...
ifelse(pvalue < alpha, "Reject Ho", "Fail to Reject Ho")
```
...
If the difference is statistically significant, we may wish to estimate the magnitude of the difference using a confidence interval. 
...
HOWEVER, we do not have at least 10 successes and 10 failures in each group, so this interval may not be appropriate.
