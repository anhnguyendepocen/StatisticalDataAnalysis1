...
INTERPRETATION: The equation of the least-squares regression line is $\hat{y}$ = `r round(wing_model$coefficients[1], 3)` + `r round(wing_model$coefficients[2], 3)`($x$). For each additional hot wing eaten, a person consumes an additional `r wing_model$coefficients[2]` ounces of beer (on average). 
