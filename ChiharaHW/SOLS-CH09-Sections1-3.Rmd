...
ggplot(Beerwings, aes(x = Hotwings, y = Beer)) +
  geom_point() +
  labs(x = "number of hot wings", y = "ounces of beer")
...
ANSWER: The histogram is very slightly left skewed and the scatterplot of residuals versus x seems to show some non-random scatter; perhaps a U-shape? A straight-line model may not be appropriate.  
